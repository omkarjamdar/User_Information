...
export class Confirm extends Component {
    ...
    render() {
        const {
            values: {step,fname,lname,date, email, phone, facebook,city,company,job,rating,summary, github }
        } = this.props;
            ...
            <div className="form-container" style={{marginTop:'7rem'}}>
                ...
                <div className="row">
                    ...
                    <div className="col-6 text-right">
                        <button className="btn btn-primary" type="submit" onClick={this.continue}>Submit</button>
                    </div>
                </div>
            </div>
        )
